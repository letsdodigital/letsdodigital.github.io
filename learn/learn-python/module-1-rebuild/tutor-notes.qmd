...
9:00 pm - Short stop to see how everyone is doing
9:05 pm - Back to Hands-on - lesson_2.py (& lesson_3.py)
9:50 pm - Talk - 5-session-close.html
10:00 pm - Close

## First hour

In the first hour of this course, introduce classes and libraries.
