...
* `Module 0` covered the coding environment and some basic python coding.
* We will quickly cover them again here.
...
![](/media/python-logo.png){ fig-align="center" width="max" height="max"}
