...
* You have 10 minutes to try and install VS code now. If no luck, then we will get you to use the `Codespace IDE`.
...
* Queries in streamlit return all data from a table in a database. 
