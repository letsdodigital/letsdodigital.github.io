...
* As modern computers communicate in binary (yes-no or true-false) form, they are said to be `digital`.
...
Output
        ...
        I am the first line read by the computer
...
* There are several naming conventions python. The convention you need to know about for this module is:
...
* Some times the traceback will underline erroneousness code with upwards arrows
...
<div class="bottom-right">
    <a href="https://letsdodigital.org/learn/learn-python/module-1/4-python-basics.html" style="color: lightgrey;">Python basics 2nd deck</a>
</div>
```