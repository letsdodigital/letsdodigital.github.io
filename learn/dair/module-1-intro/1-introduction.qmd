---
title: "DAIM Seminar 1\nIntroduction" # "{{< var dair-seminar-0 >}}"
author: "{{< var author >}}"
format: revealjs
...
## Why programming in medicine? {background-image="/media/daim/bg1.png" background-opacity="0.4"}
...
## Resources to use  {background-image="/media/python-scales.jpg" background-opacity="0.6" text-align=center}
...
## Code documentation {background-image="/media/python-scales.jpg" background-opacity="0.6" text-align=center}
...
## Github {background-image="/media/python-scales.jpg" background-opacity="0.6" text-align=center}
...
## Clinical Considerations {background-image="/media/daim/bg3.png" background-opacity="0.4"}
