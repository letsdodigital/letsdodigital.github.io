...
- As you start to write more complex code, **readability is vital**
- In general, you should aim to use **one** of the following when naming variables, etc.
  - Snake-casing e.g. `data_analytics_in_medicine`
  - Camel-casing e.g. `dataAnalyticsInMedicine`
- [More style guidelines can be found here (PEP 8)](https://peps.python.org/pep-0008/)
