...
## Module 1 - Core Python for Images {background-image="/media/daim/bg1.png" background-opacity="0.4"}

* Seminar content will include:
  * How images are digitally **represented**
  * Which **Python packages** are generally used to work with image data
* Workshop content will include:
  * How to open and render **different types** of image data  
  * Basics of **relevant Python packages** for use later in the course
  
## Module 2 - Python and DICOM {background-image="/media/daim/bg1.png" background-opacity="0.4"}
...
## Module 3 - AI for Medicine {background-image="/media/daim/bg1.png" background-opacity="0.4"}
...
* Workshop content will include:
  ...
  * **Constructing, training, and evaulating** a basic neural network for **pneumonia detection**
