...
## Module 1 - Tabular data {background-image="/media/daim/bg1.png" background-opacity="0.4"}

* TODO Specify aims of this unit with regards to EDA, etc.
  
## Module 2 - Working with DICOM  {background-image="/media/daim/bg1.png" background-opacity="0.4"}
...
## Module 3 - 3D Printing for Medicine {background-image="/media/daim/bg1.png" background-opacity="0.4"}
