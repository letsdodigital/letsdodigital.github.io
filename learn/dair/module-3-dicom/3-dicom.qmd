...
![Visualisation of different array shapes](/media/daim/np_shape_1.png)
...
## Broadcasting {background-image="/media/daim/bg_cubes_blue.png" background-opacity="0.6"}
...
## Reminder {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Houndsfield Units {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
![In the early 1970s, **Sir Godfrey Newbold Hounsfield** , a British electrical engineer presented the world with Hounsfield Units which he won the **Nobel Prize** for several years later. ](/media/daim/module_3/image8.jpg)

:::

## Why is this important for programming?  {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Windowing {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## What is DICOM? {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Metadata {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Other features of DICOM {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Examples {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## Value representation {background-image="/media/daim/bg_cubes_blue_right.png" background-opacity="0.6"}
...
## What is the difference between PACS and DICOM viewers? {.smaller}
...
| **Use Case**             | Suitable for individuals needing basic image review. | Ideal for hospitals that require comprehensive image management. |
...
![MIP of a SPECT image of a mouse. Source: Christian Lackas, <delta@lackas.net> [Originally uploaded to en.wikipedia](http://www.spect-ct.com/site/site.cgi/dispentry.site?id=38&mode=orig). Description page is/was [here](https://en.wikipedia.org/wiki/File:Mouse02-spect.gif). [CC BY-SA 3.0](https://commons.wikimedia.org/w/index.php?curid=8744558)](/media/daim/module_3/MouseMIP_Christian_Lackas.gif)
