---
title: "{{< var coding-series-title >}} - Module 1 - Evening course"
---

![](/media/ldd-lets-learn-code-coffee.png){height=300px fig-align="center" fig-alt="Let's Do Digital Logo and words 'Let's Learn Code' on a note pad held by a hand in the bottom left corner"}
...
Online, Wednesday 3^rd^ July, 7-10 pm, on Zoom.
...
<div style="display: flex; flex-direction: column; width: 100%;">
    <div style="display: flex; flex-direction: row;">
        <div style="display: flex; flex-direction: column; width: 20%; padding: 10px;">
            <a href="https://buymeacoffee.com/letsdodigital/e/244886" style="display: flex; justify-content: center;">
    ...
    <div style="display: flex; flex-direction: row;">
        <div style="display: flex; flex-direction: column; width: 20%; padding: 10px;">
            <a href="https://buymeacoffee.com/letsdodigital/e/244873" style="display: flex; justify-content: center;">
                <img src="/media/tickets.png" alt="3 tickets" style="height: 100px;">
            </a>
        </div>
        <div style="display: flex; flex-direction: column; width: 80%; padding: 10px;">
